...
from schoolapp.credentials import MpesaAccessToken, LipanaMpesaPpassword
from schoolapp.forms import ImageUploadForm
from schoolapp.models import Member, Contact, Users, ImageModel
...
def imagedelete(request, id):
        ...
        return redirect('/showimage')
def token(request):
    consumer_key = 'e5tgdgjAsrqRVobKPTvMGYSCsHwu2kGAjyFk9FjiwGfYDrTY'
    consumer_secret = 'ZEjmvdX8wnU3fRUVxWY5nQ9qJ0AQRzA4yRWCTF7opxXtlQcFcBi0Id4aeIoIpRCB'
